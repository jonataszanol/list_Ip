...
class AcessosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acesso" do
    assert_difference('Acesso.count') do
      post acessos_url, params: { acesso: { descricao: @acesso.descricao, obs: @acesso.obs } }
    end
  ...
  test "should update acesso" do
    patch acesso_url(@acesso), params: { acesso: { descricao: @acesso.descricao, obs: @acesso.obs } }
